  ...
  return (
    <>
      <div className="flex p-10 md:p-20 flex-col gap-10 md:gap-20 justify-center items-center md:flex-row ">
        ...
        >
          Hi, Im Yogá<br /> a Front-end developer working <br />at everywhere from 31°C<br /> Rangkasbitung, Indonesia.
        </h2> 
         <span className="text-slate-300 text-center md:text-start text-sm md:text-lg">Im also a UI/UX Designer and general doodler  with a<br /> keen eye for creating enganging UI, bringing product to life.</span>
        </MotionDiv>
