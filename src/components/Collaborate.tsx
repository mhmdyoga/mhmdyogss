...
const Collaborate = () => {
  return (
    ...
    <MotionDiv variants={Scroll} initial="hidden" whileInView="WhileInView" viewport={{ once: true }}  className="p-20 m-12">
        <h2 className={`text-5xl font-extrabold mb-4 text-gray-400 ${lobster.className}`}>Explore the Digital World with My Creativity: <br /> Lets Collaborate and Inspire!</h2>
